...
If you are starting a program from scratch, or you find OWASP SAMM or DSOMM ‘too much’ for your team right now, please review the following advice.
     ...
     1. Establish a Risk Based Portfolio Approach:
        ...
        **1.   ** Review your current system development life cycle and all software security activities, tooling, policies, and processes, then document them.


        2.    Perform a software inventory exercise, so that you know what you are protecting, and so that you can apply your new processes to your entire application portfolio. This includes APIs, scripts, parameterized queries for your database, and even the code your data scientists are writing.
        ...
        * Review your current system development life cycle and all software security activities, tooling, policies, and processes, then document them.
        ...
        4. Application Security Education: 
            ...
            *Consider starting a security champion program, or general security education program for your developers (sometimes called an advocacy or security awareness program), to teach them everything you wish they would know. This will keep them up to date, help them know how to do their securely, and make the security culture where you work more positive. It often also improves trust between the teams and makes for a happier working relationship.


            * The OWASP Education Project provides training materials to help educate developers on web application security. For hands-on learning about vulnerabilities, try the OWASP Juice Shop Project, or OWASP WebGoat. To stay current, come to an OWASP AppSec Conference, OWASP Conference Training, or local OWASP Chapter meetings.
...
Requirements and Resource Management Phase:
        ...
        ·      Collect and negotiate the business requirements for an application with the business, including the protection requirements with regard to confidentiality, authenticity, integrity and availability of all data assets, and the expected business logic.
         ...
         ·    Compile the technical requirements including functional and nonfunctional security requirements. OWASP recommends you use the OWASP Application Security Verification Standard (ASVS) as a guide for setting the security requirements for your application(s).
...
Planning and Design Phase:
    ...
    ·    Rather than retrofitting security into your applications and APIs, it is far more cost effective to design the security in from the start. OWASP recommends the OWASP Prevention Cheat Sheets as a good starting point for guidance on how to design security included from the beginning.
...
Secure Development Lifecycle::
        ...
        ·      Give your developers security tools, then teach them how to use them, especially static analysis, software composition analysis, secret, and IaC scanners


        ·      Create guardrails for your developers, if possible (technical safeguards to steer them towards more secure choices), 


        ·       Building strong and usable security controls is difficult.Offer secure defaults whenever possible, and create ‘paved roads’ (making the easiest way also the most secure way to do something, the obvious preferred way) whenever possible. The OWASP Prevention Cheat Sheets is a good starting point for developers, and many modern frameworks now come with standard and effective security controls for authorization, validation, CSRF prevention, etc
...
Operations and Change Management::
        ...
        ·      a way for employees (and ideally also your customers) to report bugs,


        ·      a trained incident response team that understands what software attacks look like, observability tooling,


        ·      blocking or shielding tools to stop automated attacks,


        ·      annual (or more often) hardening of configurations,


        ·      annual penetration testing (depending upon the level assurance required for your app),


        ·      processes and tooling for hardening and protecting your software supply chain,


        ·      business continuity and disaster recovery planning that includes your most important applications and the tools you use to maintain them.
...
The ASVS is the only acceptable choice for tool vendors. Tools cannot comprehensively detect, test, or protect against the OWASP Top 10 due to the nature of several of the OWASP Top 10 risks, with reference to [A06:2025-Insecure Design](?tab=t.qxp4bcsu7p4c). OWASP discourages any claims of full coverage of the OWASP Top 10, because it’s simply untrue.
