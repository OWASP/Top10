...
**Szenario Nr. 3 – Verwendung eines Pakets aus einer nicht vertrauenswürdigen Quelle:** Ein:e Entwickler:in hat Schwierigkeiten, die aktualisierte Version eines benötigten Pakets zu finden, und lädt es daher nicht vom regulären, vertrauenswürdigen Paketmanager herunter, sondern von einer Website im Internet. Das Paket ist nicht signiert, sodass keine Möglichkeit besteht, die Integrität sicherzustellen. Das Paket enthält bösartigen Code.
