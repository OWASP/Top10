...
* Una tarea para revisar y actualizar las configuraciones de acuerdo con todas las notas de seguridad, actualizaciones y parches como parte del proceso de gestión de parches (consulte [A03 Fallas en la Cadena de Suministro de Software](A03_2025-Software_Supply_Chain_Failures.md)). Revise los permisos de almacenamiento en la nube (por ejemplo, los permisos de los buckets S3).
