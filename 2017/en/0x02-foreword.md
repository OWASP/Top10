...
We have written up a range of suggested next steps for different users of the OWASP Top 10, including "What's next for developers", "What's next for testers", "What's next for organizations" which is suitable for CIOs and CISOs, "What's next for application managers", which is suitable for application owners or anyone responsible for the lifecycle of the application.
