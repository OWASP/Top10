...
* Sending security directives to clients, e.g. [Security Headers](https://wiki.owasp.org/index.php/OWASP_Secure_Headers_Project).
...
For additional requirements in this area, see the Application Security Verification Standard [V19 Configuration](https://wiki.owasp.org/index.php/ASVS_V19_Configuration).
