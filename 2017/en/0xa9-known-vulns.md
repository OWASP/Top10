...
* If any of your software is out of date. This includes the OS, web/application server, DBMS, applications, APIs and all components, runtime environments, and libraries.
