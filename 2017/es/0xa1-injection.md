...
* [Controles Proactivos de OWASP: Consultas Parametrizadas](https://wiki.owasp.org/index.php/OWASP_Proactive_Controls#2:_Parameterize_Queries)
* [Estándar de Verificación de Seguridad en Aplicaciones de OWASP: V5 Validación de entradas de datos y codificación](https://wiki.owasp.org/index.php/ASVS_V5_Input_validation_and_output_encoding)
* [Guía de Pruebas de OWASP: Inyecciones SQL](https://wiki.owasp.org/index.php/Testing_for_SQL_Injection_(OTG-INPVAL-005)), [Inyecciones de Comando](https://wiki.owasp.org/index.php/Testing_for_Command_Injection_(OTG-INPVAL-013)), [Inyecciones ORM](https://wiki.owasp.org/index.php/Testing_for_ORM_Injection_(OTG-INPVAL-007))
* [Hoja de ayuda de OWASP: Prevención de inyecciones SQL](https://wiki.owasp.org/index.php/SQL_Injection_Prevention_Cheat_Sheet)
* [Hoja de ayuda de OWASP: Prevención de inyecciones en Java](https://wiki.owasp.org/index.php/Injection_Prevention_Cheat_Sheet_in_Java)
* [Hoja de ayuda de OWASP: Consultas parametrizadas](https://wiki.owasp.org/index.php/Query_Parameterization_Cheat_Sheet)
* [Hoja de ayuda de OWASP: Defensas contra inyecciones de Comandos](https://wiki.owasp.org/index.php/Command_Injection_Defense_Cheat_Sheet)
