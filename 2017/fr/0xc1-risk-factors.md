...
* [CWE-400: Consommation de Ressources hors de contrôle ('Resource Exhaustion', 'AppDoS')](https://cwe.mitre.org/data/definitions/400.html)
* [CWE-434: Upload de fichiers ayant un type de fichier Dangereux Non Restreint](https://cwe.mitre.org/data/definitions/434.html)
* [CWE-451: Mauvaise représentation d'informations critiques dans l'Interface Utilisateur (UI) (Clickjacking et autres)](https://cwe.mitre.org/data/definitions/451.html)
* [CWE-601: Unvalidated Forward and Redirects](https://cwe.mitre.org/data/definitions/601.html)
* [CWE-799: Fréquence d'Interaction non Contrôlée (Anti-Automation)](https://cwe.mitre.org/data/definitions/799.html)
