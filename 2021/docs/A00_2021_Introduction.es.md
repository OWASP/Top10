...
- **A02:2021-Fallos criptográficos** sube una posición ubicándose en la 2da, antes conocida como A3:2017-Exposición de Datos Sensibles, que era más una característica que una causa origen. El nuevo nombre se centra en las fallas relacionadas con la criptografía, como se ha hecho implícitamente antes. Esta categoría frecuentemente conlleva a la exposición de datos confidenciales o al compromiso del sistema.
...
- Cobertura (de pruebas): El porcentaje de aplicaciones que han sido testeadas por todas las organizaciones para una determinada CWE.
