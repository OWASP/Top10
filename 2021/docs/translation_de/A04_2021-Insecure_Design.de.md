...
title: "A04:2021 – Unsicheres Design“
id: "A04:2021“
lang:	"de"
---
{%- set parent = extra.osib.document ~ "." ~ extra.osib.version -%}
{%- set osib = parent ~ ".4" -%}
#A04:2021 – Unsicheres Design ![icon](assets/TOP_10_Icons_Final_Insecure_Design.png){: style="height:80px;width:80px" align="right"} {{ osib_anchor(osib=osib, id=id, name ="Unsicheres Design", lang=lang, source=source, parent=parent) }}
...
- {{ osib_link(link="osib.owasp.cheatsheetseries.0." ~ "Sicheres Produktdesign", osib=osib) }} <!-- [OWASP Spickzettel: Sicheres Produktdesign](https://cheatsheetseries. owasp.org/cheatsheets/Secure_Product_Design_Cheat_Sheet.html) ->
